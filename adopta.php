	...
	<head>
		<?php 
			...
			function countAnimals(){
				$ch = curl_init();  
				curl_setopt($ch, CURLOPT_URL, "localhost/Pekiapp/Slim/api.php/animalesAdopcion");    
				            ...
				            <div class="col-md-12" id="pagination">
						        ...
						        <?php
						            for($i= $pagina+1; $i<= $ultima_pagina ; $i++)
						            	echo '<li><a href="adopta.php?page=' . $i . '">'.$i.'</a></li>';
	                
						            if($ultima_pagina > $pagina )
						            {      
						                echo '<li class="next"><a href="adopta.php?page=' . $nextpage . '" >Següent &raquo;</a></li>';
						            }else{
						                echo '<li class="next-off">Següent &raquo;</li>';
									}
	        
						        else:
					        	?>
	            				<li class="previous"><a href="adopta.php?page=<?php echo $prevpage;?>">&laquo; Anterior</a></li>
					            <?php 
